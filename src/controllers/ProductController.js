...
///req significa a requisição que o user está fazendo ao servidor. 
//Posso pegar do "req" parametros, corpo da requisição, cabeçalho, usuario que está fazendo, ip, autenticação...
...
module.exports = { 
  ...
  async destroy(req, res) {
    await Product.findByIdAndRemove(req.params.id); //nao preciso usar const product porque ele só vai deletar
    return res.send(); //retorna uma mensagem de sucesso sem conteudo
  },
};